...
delete_option(ADSTERRA_DASHBOARD_PLUGIN_OPTIONS_PREFIX . '_placements');
...
$wpdb->query("DELETE FROM {$wpdb->options} WHERE option_name LIKE '_transient_adsterra_widget_cache_%' OR option_name LIKE '_transient_timeout_adsterra_widget_cache_%'");
